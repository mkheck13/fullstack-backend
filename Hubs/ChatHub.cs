...
namespace fullstack_backend.Hubs
{
    public class MessagingHub : Hub
    {
        ...
        private async Task<ConversationModel> GetOrCreateConversation(
            string user1Id,
            string user2Id
        )
        {
            var conversation = await _dataContext.Conversations.FirstOrDefaultAsync(c =>
            ...
            if (conversation == null)
            {
                ...
                conversation = new ConversationModel { User1Id = user1Id, User2Id = user2Id };
        ...
        {
            var senderId = Context.ConnectionId;    //ConnectionId 
        ...
        public async Task RetrieveMessageHistory(string userId)
        {
            ...
            var conversations = await _dataContext
                .Conversations.Where(c => c.User1Id == userId || c.User2Id == userId)
